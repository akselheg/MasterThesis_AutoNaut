...
%% Learn all models
Mdl1 = fitrgp(X_Gauss, sog_data, 'KernelFunction', 'ardmatern52','BasisFunction', 'linear', ...
    'OptimizeHyperparameters' ,'auto', 'HyperparameterOptimizationOptions',...
    struct('AcquisitionFunctionName','expected-improvement-plus'));
Mdl2 = fitrgp(X_gauss2, sog_data2, 'KernelFunction', 'ardmatern52','BasisFunction', 'linear', ...% );%, ...
     'OptimizeHyperparameters' ,'auto', 'HyperparameterOptimizationOptions',...
     struct('AcquisitionFunctionName','expected-improvement-plus'));
Mdl3 = fitrgp(X_gauss3, sog_data3, 'KernelFunction', 'ardmatern52','BasisFunction', 'linear', ...% );%, ...
     'OptimizeHyperparameters' ,'auto', 'HyperparameterOptimizationOptions',...
     struct('AcquisitionFunctionName','expected-improvement-plus'));
Mdl4 = fitrgp(X_gauss4, sog_data4, 'KernelFunction', 'ardmatern52','BasisFunction', 'linear', ...% );%, ...
     'OptimizeHyperparameters' ,'auto', 'HyperparameterOptimizationOptions',...
     struct('AcquisitionFunctionName','expected-improvement-plus'));
%%
Mdl5 = fitrgp(X_gauss5, sog_data5, 'KernelFunction', 'ardmatern52','BasisFunction', 'linear', ...% );%, ...
     'OptimizeHyperparameters' ,'auto', 'HyperparameterOptimizationOptions',...
     struct('AcquisitionFunctionName','expected-improvement-plus'));
Mdl6 = fitrgp(X_gauss6, sog_data6, 'KernelFunction', 'ardmatern52','BasisFunction', 'linear', ...% );%, ...
     'OptimizeHyperparameters' ,'auto', 'HyperparameterOptimizationOptions',...
     struct('AcquisitionFunctionName','expected-improvement-plus'));
%%
Mdl7 = fitrgp(X_Gauss, sog_data, 'KernelFunction', 'ardmatern32','BasisFunction', 'linear', ...% );%, ...
 'OptimizeHyperparameters' ,'auto', 'HyperparameterOptimizationOptions',...
 struct('AcquisitionFunctionName','expected-improvement-plus'));
%%
Mdl8 = fitrgp(X_Gauss, sog_data, 'KernelFunction', 'ardsquaredexponential','BasisFunction', 'linear', ...% );%, ...
 'OptimizeHyperparameters' ,'auto', 'HyperparameterOptimizationOptions',...
 struct('AcquisitionFunctionName','expected-improvement-plus'));
