...
%     struct('AcquisitionFunctionName','expected-improvement-plus')); %'OptimizeHyperparameters', 'auto');%, 'KernelParameters', [1, std(sog_data)/sqrt(2)]);
   %%
Mdl2 = fitrgp(X_Gauss, Vr_data, 'KernelFunction', 'matern52','Sigma', 0.048352);%, ...
%     'OptimizeHyperparameters' ,'auto', 'HyperparameterOptimizationOptions',...
%     struct('AcquisitionFunctionName','expected-improvement-plus'));% 'OptimizeHyperparameters' ,'auto');
